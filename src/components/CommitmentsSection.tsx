...
export default function CommitmentsSection() {
  return (
    <section className="relative py-20 md:py-28 bg-gray-50 overflow-hidden">
      {/* Background blobs */}
      <div className="absolute top-40 -left-20 w-80 h-80 bg-indigo-100/30 rounded-full blur-3xl" />
      <div className="absolute bottom-40 -right-20 w-80 h-80 bg-purple-100/30 rounded-full blur-3xl" />
