...
export default function FloatingWhatsAppButton() {
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
      <a
        href={`mailto:${EMAIL}`}
        className="w-14 h-14 bg-red-500 hover:bg-red-600 text-white rounded-full shadow-xl shadow-red-500/40 flex items-center justify-center transition-all hover:scale-110 active:scale-95"
