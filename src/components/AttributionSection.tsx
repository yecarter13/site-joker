...
export default function AttributionSection() {
  ...
  return (
    <section className="py-16 md:py-24 bg-gradient-to-br from-red-900 via-red-800 to-red-900 text-white">
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <button
              onClick={() => openModal()}
              className="inline-flex items-center gap-2 bg-white text-red-900 hover:bg-red-50 px-6 py-3 rounded-full font-bold text-sm transition-all shadow-xl active:scale-95 cursor-pointer"
            >
              Suivre mon dossier
              <FaArrowRight className="text-xs" />
            </button>
            <p className="text-xs text-red-200/40 mt-4">
